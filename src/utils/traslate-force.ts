...
export const languajeToSpanish = (name: string): string => {
    const language = languageTraslate.find((lang) => lang.default == name)
    //console.log('languajeToSpanish', language?.spanish, name)
    return language?.spanish ?? name;
}
export const languajeToDefault = (name: string): string => {
    const language = languageTraslate.find((lang) => lang.spanish == name)
    //console.log('languajeToDefault', language?.default)
